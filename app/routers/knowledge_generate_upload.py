...
def fetch_upload_job_item_meta(conn: sqlite3.Connection, job_item_id: str) -> sqlite3.Row:
    cur = conn.execute(
        """
        SELECT
            ji.job_item_id,
    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                raw_ext = normalize_text(row["parent_key2"]).lower()
