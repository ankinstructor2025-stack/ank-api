...
def list_knowledge_items(
    ...
    uid = get_uid_from_auth_header(authorization)
    conn = _open_knowledge_db(uid, db_name)

    try:
        kt = _normalize_knowledge_type(knowledge_type)
        ...
        logger.exception("list_knowledge_items failed")
        raise HTTPException(status_code=500, detail=str(e))
